  ...
  return (
    ...
    <div className='parent'>
      {jobOpenings.map((ele,idx)=>{
        return <div key={idx}>
          <Card  brandLogo={ele.brandLogo} companyName={ele.companyName} datePosted={ele.datePosted} post={ele.post}  tag1={ele.tag1} tag2={ele.tag2} pay={ele.pay} location={ele.location}/>
        </div>
      })}
    </div>
  )
